...
static void test_1(void **_CBOR_UNUSED(state)) {
...
static void test_2(void **_CBOR_UNUSED(state)) {
...
static void test_3(void **_CBOR_UNUSED(state)) {
...
static void test_4(void **_CBOR_UNUSED(state)) {
...
static void test_5(void **_CBOR_UNUSED(state)) {
  assert_true(res.error.code == CBOR_ERR_MEMERROR);
...
static void test_6(void **_CBOR_UNUSED(state)) {
...
static void test_7(void **_CBOR_UNUSED(state)) {
...
static void test_8(void **_CBOR_UNUSED(state)) {
...
static void test_9(void **_CBOR_UNUSED(state)) {
