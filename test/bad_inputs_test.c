...
static void test_1(void **UNUSED(state)) {
...
static void test_2(void **UNUSED(state)) {
...
static void test_3(void **UNUSED(state)) {
...
static void test_4(void **UNUSED(state)) {
...
static void test_5(void **UNUSED(state)) {
  assert_true(res.error.code == CBOR_ERR_MEMERROR);
...
static void test_6(void **UNUSED(state)) {
...
static void test_7(void **UNUSED(state)) {
...
static void test_8(void **UNUSED(state)) {
...
static void test_9(void **UNUSED(state)) {
