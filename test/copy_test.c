...
static void test_uints(void **UNUSED(state)) {
...
static void test_negints(void **UNUSED(state)) {
...
static void test_def_bytestring(void **UNUSED(state)) {
...
static void test_indef_bytestring(void **UNUSED(state)) {
...
static void test_def_string(void **UNUSED(state)) {
...
static void test_indef_string(void **UNUSED(state)) {
...
static void test_def_array(void **UNUSED(state)) {
...
static void test_indef_array(void **UNUSED(state)) {
...
static void test_def_map(void **UNUSED(state)) {
...
static void test_indef_map(void **UNUSED(state)) {
...
static void test_ctrls(void **UNUSED(state)) {
  item = cbor_new_null();
...
static void test_floats(void **UNUSED(state)) {
