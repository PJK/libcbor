...
static void test_uints(void **_CBOR_UNUSED(state)) {
...
static void test_negints(void **_CBOR_UNUSED(state)) {
...
static void test_def_bytestring(void **_CBOR_UNUSED(state)) {
...
static void test_indef_bytestring(void **_CBOR_UNUSED(state)) {
...
static void test_def_string(void **_CBOR_UNUSED(state)) {
...
static void test_indef_string(void **_CBOR_UNUSED(state)) {
...
static void test_def_array(void **_CBOR_UNUSED(state)) {
...
static void test_indef_array(void **_CBOR_UNUSED(state)) {
...
static void test_def_map(void **_CBOR_UNUSED(state)) {
...
static void test_indef_map(void **_CBOR_UNUSED(state)) {
...
static void test_tag(void **_CBOR_UNUSED(state)) {
...
static void test_ctrls(void **_CBOR_UNUSED(state)) {
  item = cbor_new_null();
...
static void test_floats(void **_CBOR_UNUSED(state)) {
