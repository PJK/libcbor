...
static void test_negint16(void **UNUSED(state)) {
...
static void test_negint32(void **UNUSED(state)) {
...
static void test_negint64(void **UNUSED(state)) {
...
static void test_unspecified(void **UNUSED(state)) {
