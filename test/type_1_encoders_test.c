...
static void test_embedded_negint8(void **_CBOR_UNUSED(state)) {
  assert_int_equal(1, cbor_encode_negint8(14, buffer, 512));
  assert_memory_equal(buffer, (unsigned char[]){0x2E}, 1);
}

static void test_negint8(void **_CBOR_UNUSED(state)) {
...
static void test_negint16(void **_CBOR_UNUSED(state)) {
...
static void test_negint32(void **_CBOR_UNUSED(state)) {
...
static void test_negint64(void **_CBOR_UNUSED(state)) {
...
static void test_unspecified(void **_CBOR_UNUSED(state)) {
