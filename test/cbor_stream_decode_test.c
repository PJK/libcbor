...
static void test_no_data(void **_CBOR_UNUSED(state)) {
  assert_decoder_result_nedata(1, decode(NULL, 0));
}

unsigned char embedded_uint8_data[] = {0x00, 0x01, 0x05, 0x17};
static void test_uint8_embedded_decoding(void **_CBOR_UNUSED(state)) {
  assert_uint8_eq(0);
...
static void test_uint8_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_uint16_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_uint32_decoding(void **_CBOR_UNUSED(state)) {
...
unsigned char uint64_data[] = {0x1b, 0xa5, 0xf7, 0x02, 0xb3,
                               0xa5, 0xf7, 0x02, 0xb3};
static void test_uint64_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_negint8_embedded_decoding(void **_CBOR_UNUSED(state)) {
  assert_negint8_eq(0);
  assert_decoder_result(1, CBOR_DECODER_FINISHED,
...
static void test_negint8_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_negint16_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_negint32_decoding(void **_CBOR_UNUSED(state)) {
...
unsigned char negint64_data[] = {0x3b, 0xa5, 0xf7, 0x02, 0xb3,
                                 0xa5, 0xf7, 0x02, 0xb3};
static void test_negint64_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_bstring_embedded_int8_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_bstring_int8_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_bstring_int16_decoding(void **_CBOR_UNUSED(state)) {
...
unsigned char bstring_int32_data[] = {0x5A, 0x00, 0x10, 0x10,
                                      0x10 /*, [1052688 bytes] */};
static void test_bstring_int32_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_bstring_int64_decoding(void **_CBOR_UNUSED(state)) {
...
unsigned char bstring_indef_1_data[] = {0x5F, 0x40 /* Empty byte string */,
                                        0xFF};
static void test_bstring_indef_decoding_1(void **_CBOR_UNUSED(state)) {
...
static void test_bstring_indef_decoding_2(void **_CBOR_UNUSED(state)) {
  assert_bstring_indef_start();
  assert_decoder_result(1, CBOR_DECODER_FINISHED,
...
static void test_bstring_indef_decoding_3(void **_CBOR_UNUSED(state)) {
  assert_bstring_indef_start();
  assert_decoder_result(1, CBOR_DECODER_FINISHED,
...
static void test_array_embedded_int8_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_array_int8_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_array_int16_decoding(void **_CBOR_UNUSED(state)) {
  assert_array_start(2);
...
static void test_array_int32_decoding(void **_CBOR_UNUSED(state)) {
  assert_array_start(2);
...
static void test_array_int64_decoding(void **_CBOR_UNUSED(state)) {
  assert_array_start(2);
...
static void test_array_of_arrays_decoding(void **_CBOR_UNUSED(state)) {
  assert_array_start(2);
  assert_decoder_result(1, CBOR_DECODER_FINISHED,
...
static void test_indef_array_decoding_1(void **_CBOR_UNUSED(state)) {
...
static void test_map_embedded_int8_decoding(void **_CBOR_UNUSED(state)) {
  assert_map_start(1);
  assert_decoder_result(1, CBOR_DECODER_FINISHED,
...
static void test_map_int8_decoding(void **_CBOR_UNUSED(state)) {
  assert_map_start(1);
...
static void test_map_int16_decoding(void **_CBOR_UNUSED(state)) {
  assert_map_start(1);
...
static void test_map_int32_decoding(void **_CBOR_UNUSED(state)) {
  assert_map_start(1);
...
static void test_map_int64_decoding(void **_CBOR_UNUSED(state)) {
  assert_map_start(1);
...
static void test_indef_map_decoding_1(void **_CBOR_UNUSED(state)) {
...
static void test_embedded_tag_decoding(void **_CBOR_UNUSED(state)) {
  assert_tag_eq(1);
  assert_decoder_result(1, CBOR_DECODER_FINISHED, decode(embedded_tag_data, 1));
}

unsigned char int8_tag_data[] = {0xD8, 0xFE};
static void test_int8_tag_decoding(void **_CBOR_UNUSED(state)) {
  assert_tag_eq(254);
...
static void test_int16_tag_decoding(void **_CBOR_UNUSED(state)) {
  assert_tag_eq(65277);
...
static void test_int32_tag_decoding(void **_CBOR_UNUSED(state)) {
...
unsigned char int64_tag_data[] = {0xDB, 0xFE, 0xFD, 0xFC, 0xFB,
                                  0xFA, 0xF9, 0xF8, 0xF7};
static void test_int64_tag_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_bad_tag_decoding(void **_CBOR_UNUSED(state)) {
  assert_decoder_result(0, CBOR_DECODER_ERROR, decode(bad_tag_data, 1));
}

unsigned char float2_data[] = {0xF9, 0x7B, 0xFF};
static void test_float2_decoding(void **_CBOR_UNUSED(state)) {
...
static void test_float4_decoding(void **_CBOR_UNUSED(state)) {
...
unsigned char float8_data[] = {0xFB, 0xC0, 0x10, 0x66, 0x66,
                               0x66, 0x66, 0x66, 0x66};
static void test_float8_decoding(void **_CBOR_UNUSED(state)) {
  assert_double(-4.1);
