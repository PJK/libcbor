...
static void test_refcounting(void **UNUSED(state)) {
...
/* Tag 255 + uint 1 */
static void test_int8_tag(void **UNUSED(state)) {
...
/* Tag 255 << 8 + uint 2 */
static void test_int16_tag(void **UNUSED(state)) {
...
/* uint 3 */
static void test_int32_tag(void **UNUSED(state)) {
...
/* uint 4 */
static void test_int64_tag(void **UNUSED(state)) {
...
/* Tag 0, tag 1 + uint 0 */
static void test_nested_tag(void **UNUSED(state)) {
