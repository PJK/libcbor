...
{
	assertions_queue[queue_size++] = (struct test_assertion) {UINT16_EQ,
															  (union test_expectation_data) {.int16 = actual}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {UINT32_EQ,
															  (union test_expectation_data) {.int32 = actual}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {UINT64_EQ,
															  (union test_expectation_data) {.int64 = actual}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {NEGINT8_EQ,
															  (union test_expectation_data) {.int8 = actual}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {NEGINT16_EQ,
															  (union test_expectation_data) {.int16 = actual}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {NEGINT32_EQ,
															  (union test_expectation_data) {.int32 = actual}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {NEGINT64_EQ,
															  (union test_expectation_data) {.int64 = actual}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {BSTRING_MEM_EQ,
															  (union test_expectation_data) {.string = {address,
																										length}}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {ARRAY_START, {.length = length}};
}
...
{
	assertions_queue[queue_size++] = (struct test_assertion) {MAP_START, {.length = length}};
}
