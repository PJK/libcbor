...
static void test_embedded_uint8(void **_CBOR_UNUSED(state)) {
  assert_int_equal(1, cbor_encode_uint8(14, buffer, 512));
  assert_memory_equal(buffer, (unsigned char[]){0x0E}, 1);
}

static void test_uint8(void **_CBOR_UNUSED(state)) {
...
static void test_uint16(void **_CBOR_UNUSED(state)) {
...
static void test_uint32(void **_CBOR_UNUSED(state)) {
...
static void test_uint64(void **_CBOR_UNUSED(state)) {
